document.addEventListener('DOMContentLoaded', () => {
  ...
  // Distinct Risk Profiles across Normal, Medium, and Hard
  const multiplierTables = {
    normal: {
      8:  [4.0, 1.8, 1.3, 1.1, 0.9, 1.1, 1.3, 1.8, 4.0],
      9:  [4.5, 2.0, 1.5, 1.2, 0.9, 0.9, 1.2, 1.5, 2.0, 4.5],
      10: [5.0, 2.2, 1.6, 1.3, 1.0, 0.8, 1.0, 1.3, 1.6, 2.2, 5.0],
      11: [6.0, 2.5, 1.8, 1.4, 1.1, 0.8, 0.8, 1.1, 1.4, 1.8, 2.5, 6.0],
      12: [7.0, 3.0, 2.0, 1.5, 1.2, 1.0, 0.8, 1.0, 1.2, 1.5, 2.0, 3.0, 7.0],
      13: [8.0, 3.2, 2.2, 1.6, 1.2, 1.0, 0.8, 0.8, 1.0, 1.2, 1.6, 2.2, 3.2, 8.0],
      14: [10.0, 3.5, 2.5, 1.8, 1.3, 1.1, 1.0, 0.8, 1.0, 1.1, 1.3, 1.8, 2.5, 3.5, 10.0],
      15: [12.0, 4.0, 2.8, 2.0, 1.4, 1.1, 1.0, 0.8, 0.8, 1.0, 1.1, 1.4, 2.0, 2.8, 4.0, 12.0],
      16: [16.0, 5.0, 3.0, 2.0, 1.5, 1.2, 1.1, 1.0, 0.8, 1.0, 1.1, 1.2, 1.5, 2.0, 3.0, 5.0, 16.0]
    },
    medium: {
      ...
      14: [58.0, 15.0, 7.0, 4.0, 1.9, 1.0, 0.5, 0.3, 0.5, 1.0, 1.9, 4.0, 7.0, 15.0, 58.0],
    ...
    hard: {
      ...
      13: [260.0, 37.0, 11.0, 4.0, 1.0, 0.3, 0.2, 0.2, 0.3, 1.0, 4.0, 11.0, 37.0, 260.0],
